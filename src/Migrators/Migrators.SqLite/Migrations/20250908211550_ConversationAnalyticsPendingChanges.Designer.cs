...
namespace CleanArchitecture.Blazor.Migrators.SqLite.Migrations
{
    ...
    [Migration("20250908211550_ConversationAnalyticsPendingChanges")]
    partial class ConversationAnalyticsPendingChanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.ConversationInsight", b =>
                {
                    ...
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Conversation", null)
                        .WithOne("ConversationInsight")
                        .HasForeignKey("CleanArchitecture.Blazor.Domain.Entities.ConversationInsight", "ConversationId1");
